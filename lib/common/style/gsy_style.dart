...
class GSYICons {
  ...
  static const IconData MAIN_NLP_DT = const IconData(0xe684, fontFamily: GSYICons.FONT_FAMILY);
  static const IconData MAIN_NLP_QS = const IconData(0xe818, fontFamily: GSYICons.FONT_FAMILY);
  static const IconData MAIN_NLP_TRY = const IconData(0xe6d0, fontFamily: GSYICons.FONT_FAMILY);
