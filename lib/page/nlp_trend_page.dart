 ...
 * Date: 2019-06-06
 */
class NlpTrendPage extends StatefulWidget {
  @override
  _NlpTrendPageState createState() => _NlpTrendPageState();
}

class _NlpTrendPageState extends State<NlpTrendPage>
    with
        AutomaticKeepAliveClientMixin<NlpTrendPage>,
        GSYListState<NlpTrendPage>,
  ...
  requestRefresh() async {
    ...
    return await nlpDynamicBloc.requestRefresh(order: 'NEWEST');
  }

  @override
  requestLoadMore() async {
    return await nlpDynamicBloc.requestLoadMore(nlpDynamicBloc.nextCursor, order: 'NEWEST');
  }
